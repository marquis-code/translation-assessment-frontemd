...
//               <h3 className="text-2xl font-bold text-gray-900">Select Consultation Language</h3>
//               <button
...
//                 <strong>Note:</strong> The selected language will be used for real-time transcription. 
//                 AssemblyAI will automatically adapt to the speaker's accent and dialect.
//               </p>
//             </div>
//           </div>
//         </div>
...
//       inProgress: mockConsultations.filter((c: any) => c.status === "in_progress").length,
//       today: mockConsultations.filter((c: any) => 
...
//       console.log("Starting consultation with language:", selectedLanguage);
//       alert(`Consultation started with language: ${selectedLanguage}`);
//     } catch (err) {
//       console.error(err);
