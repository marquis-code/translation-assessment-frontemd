...
//     // Get selected language from session storage (set in dashboard)
...
//                     <svg className="animate-spin h-4 w-4 text-yellow-700" fill="none" viewBox="0 0 24 24">
//                       <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
//                       <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
//                     </svg>
//                     <span className="text-xs text-yellow-800 font-medium">Translating...</span>
//                   </div>
//                 )}
//               </div>
...
//        {/* Action Footer */}           <div className="bg-gray-50 px-6 py-5 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center gap-4">
//             <div className="text-sm text-gray-700 flex items-center gap-2">
//                <svg className="w-5 h-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
//                </svg>
    ...
    try {
      ...
      ws.onmessage = async (event) => {
        try {
          ...
          if (data.type === "transcript") {
            // Backend has already translated the text
            ...
            if (data.is_final) {
              ...
              setCurrentText("");
              console.log(`✅ Final transcript saved (${transcriptLanguage}):`, displayText);
            } else {
