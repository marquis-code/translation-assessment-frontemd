...
//   const [consultationLanguage, setConsultationLanguage] = useState("en");
...
//         }
//       );
//       setConsultationLanguage(response.data.language || "en");
//       console.log("Consultation language:", response.data.language);
//     } catch (err) {
...
//       const wsUrl = `${wsProtocol}//${wsHost}/ws/transcribe/${consultationId}?language=${consultationLanguage}`;
...
//       ws.onopen = () => {
//         console.log(`WebSocket connected with language: ${consultationLanguage}`);
//         setError("");
//         setIsRecording(true);
//         setShowTip(false);
//       };
...
//                     Language: <span className="font-semibold">{consultationLanguage.toUpperCase()}</span>
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//                 <p className="text-blue-800 text-sm">Click "Start Recording" to begin transcribing your consultation in <strong>{consultationLanguage.toUpperCase()}</strong>. The AI will automatically detect and label Doctor and Patient speakers.</p>
//               </div>
...
// export default function TranscriptionPage() {
//   const consultationId = "demo-consultation-123";
...
//   const [audioLevel, setAudioLevel] = useState(0) as any
...
//       const wsProtocol = window.location.protocol === "https:" ? "wss:" : "ws:";
//       const wsHost = API_BASE_URL.replace("https://", "").replace("http://", "");
//       const wsUrl = `${wsProtocol}//${wsHost}/ws/transcribe/${consultationId}`;
...
//       console.log("Generating summary for", transcript.length, "segments");
//       alert("Summary generation complete! Redirecting to summary page...");
//     } catch (err) {
//       console.error("Error:", err);
//       setError("Failed to generate summary. Please try again.");
//     } finally {
